# new growth function (first half)
# growth comparison (second half)

### NEW GROWTH FUNCTION (and auxilary functions)

source("/Users/Michel/Desktop/Research/code/ProtScavFluxCalculation/protein_influx_functions_v3.R")
...
growth.func.new <- function(data, name) {
  ...
  growth.integral <- do.integral(curve.params$intercept, curve.params$rate, curve.params$max)
