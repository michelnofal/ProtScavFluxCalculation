...
# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/BMK_White_Lab/BMK_parental/D3_pcv_data.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/BMK_White_Lab/BMK_parental/D3_IC_data.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/BMK_White_Lab/BMK_parental/D3_media_data.csv", header=TRUE, sep=",")
...
if (saveRData) {
  ...
  save(D3_1_fluxes, file=paste(data_folder,"R_data/D3_1_fluxes.Rda",sep=""))
}
