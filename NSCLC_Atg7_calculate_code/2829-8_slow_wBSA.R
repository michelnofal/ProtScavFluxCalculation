...
file_handle <- "2829-8_slow"
data_folder <- "ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/"

# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_slow/2829-8slow_pcv.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_slow/2829-8slow_intra.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_slow/2829-8slow_media.csv", header=TRUE, sep=",")
...
# saveRData = TRUE
if (saveRData) {
  Atg7_28298_slow_wBSA_fluxes <- fluxes.list$fluxes
  Atg7_28298_slow_wBSA_fluxes$data = "28298_slow_wBSA"
  Atg7_28298_slow_wBSA_AAlab <- aa.lab.list
  save(Atg7_28298_slow_wBSA_fluxes, Atg7_28298_slow_wBSA_AAlab, 
       file=paste(data_folder,"R_data/Atg7_28298_slow_wBSA_fluxes.Rda",sep=""))
}
...
if (saveCleanPlots) {
  ...
  #                directory="ProtScavFluxCalculation/Figures/", filename="HOPS1_Intergenic_LabPlot")
  ...
  ProtScavFlux.plotter(28298_slow_wBSA_fluxes %>% filter(compound != "tyrosine"), save=TRUE,
                       directory="ProtScavFluxCalculation/Figures/NSCLC_Atg7/", filename="28298_slow_wBSA_LabPlot")
  
  FluxComparison.Plotter(HOPS1_intergenic_fluxes, normTo1=FALSE, save=TRUE,
                         directory="ProtScavFluxCalculation/Figures/NSCLC_Atg7/", filename="28298_slow_wBSA_LabPlot")
  FluxComparison.Plotter(HOPS1_intergenic_fluxes, normTo1=TRUE, save=TRUE,
                         directory="ProtScavFluxCalculation/Figures/NSCLC_Atg7/", filename="28298_slow_wBSA_LabPlot")
}
