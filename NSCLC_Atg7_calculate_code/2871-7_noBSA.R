...
file_handle <- "2871-7_noBSA"
data_folder <- "ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/"

# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgWT_28717_noBSA/2871-7_noBSA_pcv.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgWT_28717_noBSA/2871-7_noBSA_intra.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgWT_28717_noBSA/2871-7_noBSA_media.csv", header=TRUE, sep=",")
...
# saveRData = TRUE
if (saveRData) {
  Atg7_28717_noBSA_fluxes <- fluxes.list$fluxes
  Atg7_28717_noBSA_fluxes$data = "Atg7_28717_noBSA"
  Atg7_28717_noBSA_AAlab <- aa.lab.list
  save(Atg7_28717_noBSA_fluxes, Atg7_28717_noBSA_AAlab, 
       file=paste(data_folder,"R_data/Atg7_28717_noBSA_fluxes.Rda",sep=""))
}
