...
file_handle <- "2829-8_noBSA_slow"
data_folder <- "ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/"

# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_noBSA_slow/2829-8slow_noBSA_pcv.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_noBSA_slow/2829-8slow_noBSA_intra.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/NSCLC_Atg_WTvNull/NSCLC_Ras_AtgNull_28298_noBSA_slow/2829-8slow_noBSA_media.csv", header=TRUE, sep=",")
...
# saveRData = TRUE
if (saveRData) {
  Atg7_28298_slow_noBSA_fluxes <- fluxes.list$fluxes
  Atg7_28298_slow_noBSA_fluxes$data = "28298_slow_noBSA"
  Atg7_28298_slow_noBSA_AAlab <- aa.lab.list
  save(Atg7_28298_slow_noBSA_fluxes, Atg7_28298_slow_noBSA_AAlab, 
       file=paste(data_folder,"R_data/Atg7_28298_slow_noBSA_fluxes.Rda",sep=""))
}
