...
file_handle <- "Vps39_TC1_Vps39_8_5C"
data_folder <- "ProtScavFluxCalculation/Data/HOPS complex/"

# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_Vps39_8_5C_pcv.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_Vps39_8_5C_intra.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_Vps39_8_5C_media.csv", header=TRUE, sep=",")
...
# saveRData = TRUE
if (saveRData) {
  HOPS1_Vps39_8_5C_fluxes <- fluxes.list$fluxes
  HOPS1_Vps39_8_5C_fluxes$data = "HOPS1_Vps39_8_5C"
  HOPS1_Vps39_8_5C_AAlab <- aa.lab.list
  save(HOPS1_Vps39_8_5C_fluxes, HOPS1_Vps39_8_5C_AAlab, file=paste(data_folder,"R_data/HOPS1_Vps39_8_5C_fluxes.Rda",sep=""))
}
...
if (saveCleanPlots) {
  ...
  #                directory="ProtScavFluxCalculation/Figures/", filename="HOPS1_Vps39_8_5C_LabPlot")
  ...
  ProtScavFlux.plotter(Ras1_fluxes %>% filter(compound != "tyrosine"), save=TRUE,
                       directory="ProtScavFluxCalculation/Figures/HOPS complex/", filename="HOPS1_Vps39_8_5C_LabPlot")
  
  FluxComparison.Plotter(HOPS1_Vps39_8_5C_fluxes, normTo1=FALSE, save=TRUE,
                         directory="ProtScavFluxCalculation/Figures/HOPS complex/", filename="HOPS1_Vps39_8_5C_LabPlot")
  FluxComparison.Plotter(HOPS1_Vps39_8_5C_fluxes, normTo1=TRUE, save=TRUE,
                         directory="ProtScavFluxCalculation/Figures/HOPS complex/", filename="HOPS1_Vps39_8_5C_LabPlot")
