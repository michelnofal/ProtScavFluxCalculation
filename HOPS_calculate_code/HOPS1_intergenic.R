...
file_handle <- "Vps39_TC1_intergenic"
data_folder <- "ProtScavFluxCalculation/Data/HOPS complex/"

# import data
growth.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_intergenic_pcv.csv", header=TRUE, sep=",")
intra.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_intergenic_intra.csv", header=TRUE, sep=",")
extra.dat <- read.table("ProtScavFluxCalculation/Data/HOPS complex/VpsTC1_intergenic_media.csv", header=TRUE, sep=",")
...
# saveRData = TRUE
if (saveRData) {
  HOPS1_intergenic_fluxes <- fluxes.list$fluxes
  HOPS1_intergenic_fluxes$data = "HOPS1_intergenic"
  HOPS1_intergenic_AAlab <- aa.lab.list
  save(HOPS1_intergenic_fluxes, HOPS1_intergenic_AAlab, file=paste(data_folder,"R_data/HOPS1_intergenic_fluxes.Rda",sep=""))
}
...
if (saveCleanPlots) {
  ...
  ProtScavFlux.plotter(HOPS1_intergenic_fluxes %>% filter(compound != "tyrosine"), save=TRUE,
